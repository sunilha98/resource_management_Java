...
public class DashboardMetricsDTO {
    ...
    public DashboardMetricsDTO(Integer activeProjects, Integer totalResources, Integer utilizationRate, Integer benchResources) {
    ...
    public Integer getBenchResources() { return benchResources; }
    public void setBenchResources(Integer benchResources) { this.benchResources = benchResources; }
}