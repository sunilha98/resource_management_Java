...
public class Sow {
    ...
    public String getSowNumber() { return sowNumber; }
    public void setSowNumber(String sowNumber) { this.sowNumber = sowNumber; }
    ...
    public void setStatus(SowStatus status) { this.status = status; }
